...
[![x-cmd/install — envx Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/envx.svg?lang=zh)](https://x-cmd.com/install/envx)
...
- **上游仓库**: <https://github.com/mikeleppane/envx>
- **许可证**: MIT

## 发布

- **最新版本**: `v0.6.2` (2025-09-19)
- **最近提交**: 2025-09-19
- **Release 含资产**: 5 个

## 流行度

- **Star**: 231 · **Fork**: 7 · **开放 issue**: 6 · **贡献者**: 1

## 累计统计

- **发布数**: 10 · **已合并 PR**: 12 · **开放 PR**: 1 · **已关闭 issue**: 1 · **开放 issue**: 5 · **提交数**: 22
...
| 360d | 2025-09-28 | 0 | 0 | 1 | 0 | 3 | 0 |
| last720d | 2024-10-03 | 10 | 12 | 1 | 1 | 5 | 22 |
...
envx 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `envx` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/envx.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T05:36:08Z._
